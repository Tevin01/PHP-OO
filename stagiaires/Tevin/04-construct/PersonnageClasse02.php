...
class PersonnagClasse02{
    ...
    //Méthodes
        ...
        /* le constructeur est une méthode magique qui permet lors de l'instanciation
        (avec le mot clef new) de passer des paramètres directement à l'instance de classe */
        ...
        public function setEspece(string $espece){
            if(in_array($espece, self::ESPECE_CHOICE)){
                ...
                throw new Exception("Scram now! Or face the consequences!");
            }
        }

...
class PersonnageWarrior extends PersonnageAbstract implements ActionsPersonnageInterface, PassivePersonnageInterface{
    ...
    */
    ...
    protected function initPersonnage(): void
    {
        // texte de présentation
        $this->setInfoPersonnage("<h4>Création d'un ".self::class."  {$this->getEspece()} nommé {$this->getName()}</h4>");
    ...
    /**
     * Get the value of infoPersonnage
     */ 
    public function getInfoPersonnage()
    {
        return $this->infoPersonnage;
    }

    /**
     * Set the value of infoPersonnage
     *
     * @return  self
     */ 
    public function setInfoPersonnage($infoPersonnage)
    {
        $this->infoPersonnage = $infoPersonnage;
